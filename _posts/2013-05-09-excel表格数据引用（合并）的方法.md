...
解释一下这个函数的功能，我们想在这里填入张三的成绩，A2表示要查找的条件，这里他的值是1001，我们要查找学号1001的成绩。Sheet2!$A$2:$B$7,2表示查找的范围，张三的成绩要从sheet2表的A2到B7之间的范围内查找�?表示查找的结果所在列，这里成绩在sheet2表的第二列，所以填�?”， FALSE表示非顺序查找�?
输入完成以上的内容然后“回车”，张三的成绩就会显示出来了�?
其他同学的成绩你也可以按着上面的方法来输入，比如王二的成绩的函数为=VLOOKUP(A3,Sheet2!$A$2:$B$7,2,FALSE).区别就是王二的学�?002在sheet1的位置是A3.
