---
title: "修改Flickr Manager插入默认图片大小的按�?
date: 2010-11-25
categories: 
  - "website"
tags: 
...
修改成为默认的尺寸为Medium的方法是，找到FlickrManager.php，修�?634行的thumbnail为medium�?
修改前：
...
找到FlickrCore.php文件�?94行：

```
$sizes = array('square' => '_s', 'thumbnail' => '_t', 'small' => '_m', 'medium' => '', 'large' => '_b', 'original' => '_o');
```

因为Medium 640的值为’\_z’，假设你极少使�?square' => '\_s'，我们就把它给替换成'square' => '\_z'。当然你可以替换成其他的极少使用的尺寸。修改后的代码为�?
```
